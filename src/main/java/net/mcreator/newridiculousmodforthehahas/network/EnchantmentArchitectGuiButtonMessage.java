...
public class EnchantmentArchitectGuiButtonMessage {
	...
	public EnchantmentArchitectGuiButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(EnchantmentArchitectGuiButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(EnchantmentArchitectGuiButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
