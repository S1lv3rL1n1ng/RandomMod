...
public class VortexBladeEntitySwingsItemProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
			...
			return;
		{
			...
			for (Entity entityiterator : _entfound) {
				if ((entityiterator.getPersistentData().getString("player")).equals(entity.getDisplayName().getString())) {
					entityiterator.lookAt(EntityAnchorArgument.Anchor.EYES,
