...
public class VortexSwordRenderer extends MobRenderer<VortexSwordEntity, ModelVortexSword<VortexSwordEntity>> {
	public VortexSwordRenderer(EntityRendererProvider.Context context) {
		super(context, new ModelVortexSword(context.bakeLayer(ModelVortexSword.LAYER_LOCATION)), 0.5f);
		this.addLayer(new RenderLayer<VortexSwordEntity, ModelVortexSword<VortexSwordEntity>>(this) {
			...
			@Override
			public void render(PoseStack poseStack, MultiBufferSource bufferSource, int light, VortexSwordEntity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
	...
	@Override
	public ResourceLocation getTextureLocation(VortexSwordEntity entity) {
