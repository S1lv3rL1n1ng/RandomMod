...
public class EnchantmentArchitectGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public EnchantmentArchitectGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(NewRidiculousModForTheHahasModMenus.ENCHANTMENT_ARCHITECT_GUI.get(), id);
