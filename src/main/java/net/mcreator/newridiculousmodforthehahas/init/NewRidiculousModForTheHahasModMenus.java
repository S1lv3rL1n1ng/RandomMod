...
public class NewRidiculousModForTheHahasModMenus {
	...
	public static final RegistryObject<MenuType<TrialTotemGUIMenu>> TRIAL_TOTEM_GUI = REGISTRY.register("trial_totem_gui", () -> IForgeMenuType.create(TrialTotemGUIMenu::new));
}
